...
namespace PracticalLab.BLL
{
    public class BaseEdgeDetection : IEdgeDetection
    {
        ...
        public void applyEdgeDetectionWithConvolution(Bitmap sourceBitmap,
                                             double[,] filterMatrix,
                                                  double factor = 1,
                                                       int bias = 0,
        ...
        public void applyEdgeDetectionWithConvolution(Bitmap sourceBitmap, double[,] xFilterMatrix,double[,] yFilterMatrix, double factor = 1,int bias = 0, bool grayscale = false)
        {
            BitmapData sourceData = sourceBitmap.LockBits(new Rectangle(0, 0,
                                     sourceBitmap.Width, sourceBitmap.Height),
                                                       ImageLockMode.ReadOnly,
